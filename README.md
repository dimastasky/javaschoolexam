...
* GitHub Actions: [![example workflow](https://github.com/dimastasky/javaschoolexam/actions/workflows/java_ci.yml/badge.svg?event=push)](https://github.com/dimastasky/javaschoolexam/actions/workflows/java_ci.yml)
